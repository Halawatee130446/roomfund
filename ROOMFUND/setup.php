...
try {
    ...
    $channels_file = __DIR__.'/codebackend/payment_channels.php';
    ...
    echo "<br><br><br><P> รันไฟล์ login.php เพื่อเข้าสู่ระบบ </P>";
    echo "<p>Setup finished. You can now go to <a href='start/login.php'>login.php</a>.</p>";
