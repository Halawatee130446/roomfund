...
?>
<link rel="stylesheet" href="<?php echo BASE_URL; ?>../assets/create_period.css">
<div class="form-card">
    ...
    <form method="post" action="<?php echo BASE_URL; ?>/forms/create_period.php" class="styled-form">
